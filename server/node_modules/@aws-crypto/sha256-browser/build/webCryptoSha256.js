...
***REMOVED***;
        ...
        if (this.key) {
            return this.key.then(function (key) {
                return (0, util_locate_window_1.locateWindow)()
                    ...
                    .then(function (data) { return new Uint8Array(data); ***REMOVED***
            ***REMOVED***
    ***REMOVED***
    ...
    ***REMOVED***)
            .then(function (data) { return Promise.resolve(new Uint8Array(data)); ***REMOVED***
***REMOVED***;
        ...
        if (this.secret && this.secret !== void 0) {
            this.key = new Promise(function (resolve, reject) {
                (0, util_locate_window_1.locateWindow)()
                    ...
                    .then(resolve, reject);
            ***REMOVED***
            this.key.catch(function () { ***REMOVED***
    ***REMOVED***
***REMOVED***;
    return Sha256;
}());
