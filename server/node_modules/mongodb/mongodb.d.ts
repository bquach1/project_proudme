...
export declare abstract class AbstractCursor<TSchema = any, CursorEvents extends AbstractCursorEvents = AbstractCursorEvents> extends TypedEventEmitter<CursorEvents> {
     ...
     *
     * ```typescript
     * const cursor = collection.find({***REMOVED***
     * cursor.map(() => null);
     *
...
***REMOVED*** | string): this;
     ...
     * ```typescript
     * // Best way
     * const docs: AggregationCursor<{ a: number }> = cursor.project<{ a: number }>({ _id: 0, a: true ***REMOVED***
     * // Flexible way
     * const docs: AggregationCursor<Document> = cursor.project({ _id: 0, a: true ***REMOVED***
     * ```
     *
     * @remarks
     * In order to strictly type this function you must provide an interface
     ...
     * const projectCursor = cursor.project<{ a: number }>({ _id: 0, a: true ***REMOVED***
...
export declare interface BSONSerializeOptions extends Omit<SerializeOptions, 'index'>, Omit<DeserializeOptions, 'evalFunctions' | 'cacheFunctions' | 'cacheFunctionsCrc32' | 'allowObjectSmallerThanBufferSize' | 'index' | 'validation'> {
     ...
     * @example
     * ```ts
     * const raw = await collection.findOne({}, { raw: true ***REMOVED***
...
export declare abstract class BulkOperationBase {
     ...
     * bulkOp.find({ a: 1 }).updateOne({ $set: { b: 2 } ***REMOVED***
     *
     * // Add an updateMany to the bulkOp
     * bulkOp.find({ c: 3 }).update({ $set: { d: 4 } ***REMOVED***
     *
     * // Add an upsert
     * bulkOp.find({ e: 5 }).upsert().updateOne({ $set: { f: 6 } ***REMOVED***
     *
     * // Add a deletion
     ...
     *
     * // Add a replaceOne
     * bulkOp.find({ i: 9 }).replaceOne({writeConcern: { j: 10 }***REMOVED***
     *
...
export declare class Collection<TSchema extends Document = Document> {
     ...
     *
     * await collection.createIndex({ a: 1, b: -1 ***REMOVED***
     *
...
export declare class Db {
    ...
    listCollections(filter: Document, options: Exclude<ListCollectionsOptions, 'nameOnly'> & {
        nameOnly: true;
***REMOVED***): ListCollectionsCursor<Pick<CollectionInfo, 'name' | 'type'>>;
    listCollections(filter: Document, options: Exclude<ListCollectionsOptions, 'nameOnly'> & {
        nameOnly: false;
***REMOVED***): ListCollectionsCursor<CollectionInfo>;
...
export declare class FindCursor<TSchema = any> extends AbstractCursor<TSchema> {
     ...
     * ```typescript
     * // Best way
     * const docs: FindCursor<{ a: number }> = cursor.project<{ a: number }>({ _id: 0, a: true ***REMOVED***
     * // Flexible way
     * const docs: FindCursor<Document> = cursor.project({ _id: 0, a: true ***REMOVED***
     * ```
     *
     * @remarks
     *
...
***REMOVED*** | Map<string, IndexDirection>;
}
...
export declare class MongoBulkWriteError extends MongoServerError {
    ...
    constructor(error: {
        ...
        code: number;
        writeErrors?: WriteError[];
***REMOVED*** | WriteConcernError | AnyError, result: BulkWriteResult);
    get name(): string;
    /** Number of documents inserted. */
    get insertedCount(): number;
    /** Number of documents matched for update. */
 ...
 * const client = new MongoClient('mongodb://localhost:27017', { monitorCommands: true ***REMOVED***
 *
 * client.on('commandStarted', started => console.log(started));
 * client.db().collection('pets');
 * await client.insertOne({ name: 'spot', kind: 'dog' ***REMOVED***
 * ```
 */
