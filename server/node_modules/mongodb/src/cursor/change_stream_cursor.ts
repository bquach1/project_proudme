...
export type ChangeStreamAggregateRawResult<TChange> = {
  ...
  cursor: {
    ...
    ns: string;
    id: number | Long;
***REMOVED*** & ({ firstBatch: TChange[] } | { nextBatch: TChange[] ***REMOVED***
  ok: 1;
...
***REMOVED*** else if (options.resumeAfter) {
...
***REMOVED***
  ...
  ***REMOVED***
***REMOVED*** else if (this.startAtOperationTime != null && maxWireVersion(this.server) >= 7) {
...
***REMOVED***
  ...
  _initialize(session: ClientSession, callback: Callback<ExecutionResult>): void {
    ...
    ***REMOVED***
        ...
        // TODO: NODE-2882
        callback(undefined, { server, session, response ***REMOVED***
  ***REMOVED***
    );
***REMOVED***
