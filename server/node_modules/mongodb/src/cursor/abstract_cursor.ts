...
***REMOVED***
      this[kSession] = this[kClient].startSession({ owner: this, explicit: false ***REMOVED***
***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  withReadConcern(readConcern: ReadConcernLike): this {
    assertUninitialized(this);
    const resolvedReadConcern = ReadConcern.fromOptions({ readConcern ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
        this[kSession] = this.client.startSession({ owner: this, explicit: false ***REMOVED***
  ***REMOVED***
***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
      ...
      if (!session.inTransaction()) {
        maybeClearPinnedConnection(session, { error ***REMOVED***
  ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
      ...
      if (result == null) {
        this.push(null);
  ***REMOVED*** else if (this.destroyed) {
        this._cursor.close().catch(() => null);
  ***REMOVED***
        if (this.push(result)) {
