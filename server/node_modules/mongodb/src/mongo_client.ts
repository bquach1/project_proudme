...
***REMOVED***
  ...
  get options(): Readonly<MongoOptions> {
    return Object.freeze({ ...this[kOptions] ***REMOVED***
***REMOVED***

  get serverApi(): Readonly<ServerApi | undefined> {
    return this[kOptions].serverApi && Object.freeze({ ...this[kOptions].serverApi ***REMOVED***
***REMOVED***
  /**
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED*** catch (error) {
          topology.close({ force: true ***REMOVED***
          throw error;
    ***REMOVED***
  ***REMOVED***;
