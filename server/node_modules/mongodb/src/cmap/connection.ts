...
***REMOVED***
  ...
  onError(error: Error) {
    if (this.closed) {
      return;
***REMOVED***
    this.destroy({ force: false ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
      ...
      this[kQueue].clear();
      this.emit(Connection.CLOSE);
***REMOVED***, 1).unref(); // No need for this timer to hold the event loop open
***REMOVED***
...
***REMOVED*** else if (operationDescription.socketTimeoutOverride) {
