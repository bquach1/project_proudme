...
***REMOVED***
    ...
    // Clone the options
    const finalOptions = Object.assign({}, options, { wireProtocolCommand: false ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else if (connection) {
        this.s.pool.clear({ serviceId: connection.serviceId ***REMOVED***
  ***REMOVED***
***REMOVED***
