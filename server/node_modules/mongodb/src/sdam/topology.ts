...
***REMOVED*** else if (!Array.isArray(seeds)) {
      seeds = [seeds];
***REMOVED***
  ...
  ***REMOVED*** else if (seed instanceof HostAddress) {
        seedlist.push(seed);
  ***REMOVED***
...
***REMOVED***
    ...
    const destroyedServers = Array.from(this.s.servers.values(), server => {
      return promisify(destroyServer)(server, this, { force: !!options?.force ***REMOVED***
    ***REMOVED***
...
***REMOVED***;
  ...
  ***REMOVED***, serverSelectionTimeoutMS);
***REMOVED***
  ...
  if (incomingServerDescription && topology.s.servers.has(incomingServerDescription.address)) {
    ...
    if (server) {
      ...
      if (
        ...
        server.s.pool.clear({ interruptInUseConnections ***REMOVED***
  ***REMOVED*** else if (incomingServerDescription.error == null) {
...
***REMOVED***
    ...
    if (selectedDescriptions.length === 0) {
      ...
      continue;
***REMOVED*** else if (selectedDescriptions.length === 1) {
