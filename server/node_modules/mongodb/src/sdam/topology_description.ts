...
***REMOVED***
    ...
    ***REMOVED***
  ***REMOVED*** else if (serverDescriptions.size < srvMaxHosts) {
...
***REMOVED***
  ...
  ***REMOVED*** else if (NON_PRIMARY_RS_MEMBERS.has(serverType)) {
...
***REMOVED***
  ...
  ***REMOVED*** else if (serverType === ServerType.RSPrimary) {
        const result = updateRsFromPrimary(
          serverDescriptions,
          serverDescription,
          setName,
