...
***REMOVED***
  ...
  if (coll && coll.writeConcern) {
    return Object.assign(target, { writeConcern: Object.assign({}, coll.writeConcern) ***REMOVED***
***REMOVED***

  if (db && db.writeConcern) {
    return Object.assign(target, { writeConcern: Object.assign({}, db.writeConcern) ***REMOVED***
***REMOVED***
...
export function decorateWithReadConcern(
  ...
  if (options && options.session && options.session.inTransaction()) {
    return;
***REMOVED***
  const readConcern = Object.assign({}, command.readConcern || {***REMOVED***
...
***REMOVED*** else if ('s' in provider && 'client' in provider.s && provider.s.client.topology) {
    return provider.s.client.topology;
***REMOVED*** else if ('s' in provider && 'db' in provider.s && provider.s.db.s.client.topology) {
...
***REMOVED*** else if (isRecord(value)) {
    const res = {} as any;
...
***REMOVED***
  ...
  constructor() {
    ...
    this.head = {
      ...
      prev: null,
      value: null
***REMOVED*** as unknown as EmptyNode;
...
***REMOVED***
    ...
    if (typeof port === 'number') {
      this.port = port;
***REMOVED*** else if (typeof port === 'string' && port !== '') {
