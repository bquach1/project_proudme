    ...
    if (conn && topology != null) {
        ...
        if ((options === null || options === void 0 ? void 0 : options.error) == null || (options === null || options === void 0 ? void 0 : options.force)) {
            ...
            if (options === null || options === void 0 ? void 0 : options.forceClear) {
                loadBalancer.s.pool.clear({ serviceId: conn.serviceId ***REMOVED***
        ***REMOVED***
    ***REMOVED***
...
***REMOVED***
    if (txnState === transactions_1.TxnState.TRANSACTION_COMMITTED) {
        writeConcern = Object.assign({ wtimeout: 10000 }, writeConcern, { w: 'majority' ***REMOVED***
***REMOVED***
    if (writeConcern) {
        Object.assign(command, { writeConcern ***REMOVED***
***REMOVED***
    if (commandName === 'commitTransaction' && session.transaction.options.maxTimeMS) {
        Object.assign(command, { maxTimeMS: session.transaction.options.maxTimeMS ***REMOVED***
***REMOVED***
    function commandHandler(error, result) {
        if (commandName !== 'commitTransaction') {
            session.transaction.transition(transactions_1.TxnState.TRANSACTION_ABORTED);
            if (session.loadBalanced) {
                maybeClearPinnedConnection(session, { force: false ***REMOVED***
        ***REMOVED***
    ...
    ***REMOVED***
        if (error instanceof error_1.MongoError && error.hasErrorLabel(error_1.MongoErrorLabel.RetryableWriteError)) {
            ...
            if (command.commitTransaction) {
                // per txns spec, must unpin session in this case
                session.unpin({ force: true ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***, ServerSession.prototype);
***REMOVED***
}
...
***REMOVED***
    ...
    ***REMOVED***
        if (session.supports.causalConsistency &&
            ...
            Object.assign(command.readConcern, { afterClusterTime: session.operationTime ***REMOVED***
    ***REMOVED***
        else if (session[kSnapshotEnabled]) {
            command.readConcern = command.readConcern || { level: read_concern_1.ReadConcernLevel.snapshot };
            if (session[kSnapshotTime] != null) {
                Object.assign(command.readConcern, { atClusterTime: session[kSnapshotTime] ***REMOVED***
        ***REMOVED***
    ***REMOVED***
        return;
***REMOVED***
