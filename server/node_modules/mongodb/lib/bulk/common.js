    ...
    ***REMOVED***
            ...
            for (let i = 0; i < this.result.writeConcernErrors.length; i++) {
                ...
                if (i === 0)
                    errmsg = errmsg + ' and ';
        ***REMOVED***
            return new WriteConcernError({ errmsg, code: error_1.MONGODB_ERROR_CODES.WriteConcernFailed ***REMOVED***
    ***REMOVED***
***REMOVED***
...
***REMOVED***, new BulkWriteResult(bulkResult)));
}
/**
...
***REMOVED***
    ...
    ***REMOVED***
        if ('replaceOne' in op || 'updateOne' in op || 'updateMany' in op) {
            ...
            ***REMOVED***
                const updateStatement = (0, update_1.makeUpdateStatement)(op.replaceOne.filter, op.replaceOne.replacement, { ...op.replaceOne, multi: false ***REMOVED***
