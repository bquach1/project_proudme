...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***
        return new TopologyDescription(this.type, serverDescriptions, this.setName, this.maxSetVersion, this.maxElectionId, this.commonWireVersion, { heartbeatFrequencyMS: this.heartbeatFrequencyMS, localThresholdMS: this.localThresholdMS ***REMOVED***
***REMOVED***
    /**
    ...
    ***REMOVED***
        ...
        if (topologyType === common_1.TopologyType.Single) {
            ...
            return new TopologyDescription(common_1.TopologyType.Single, serverDescriptions, setName, maxSetVersion, maxElectionId, commonWireVersion, { heartbeatFrequencyMS: this.heartbeatFrequencyMS, localThresholdMS: this.localThresholdMS ***REMOVED***
    ***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***
        return new TopologyDescription(topologyType, serverDescriptions, setName, maxSetVersion, maxElectionId, commonWireVersion, { heartbeatFrequencyMS: this.heartbeatFrequencyMS, localThresholdMS: this.localThresholdMS ***REMOVED***
***REMOVED***
    get error() {
