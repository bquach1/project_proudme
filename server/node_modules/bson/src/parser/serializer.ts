...
function serializeMinMax(
  ...
  if (value === null) {
    buffer[index++] = constants.BSON_DATA_NULL;
***REMOVED*** else if (value._bsontype === 'MinKey') {
...
***REMOVED*** else if (isUint8Array(value.id)) {
...
export function serializeInto(
  ...
  ***REMOVED*** else if (typeof value === 'bigint') {
        throw new BSONTypeError('Unsupported type BigInt, please use Decimal128');
  ***REMOVED*** else if (typeof value === 'boolean') {
  ...
  ***REMOVED*** else if (value === null) {
        index = serializeNull(buffer, key, value, index, true);
  ***REMOVED*** else if (value['_bsontype'] === 'ObjectId' || value['_bsontype'] === 'ObjectID') {
        index = serializeObjectId(buffer, key, value, index, true);
  ***REMOVED*** else if (isUint8Array(value)) {
        index = serializeBuffer(buffer, key, value, index, true);
  ***REMOVED*** else if (value instanceof RegExp || isRegExp(value)) {
        index = serializeRegExp(buffer, key, value, index, true);
  ***REMOVED*** else if (typeof value === 'object' && value['_bsontype'] == null) {
  ...
  ***REMOVED*** else if (typeof value['_bsontype'] !== 'undefined') {
        throw new BSONTypeError(`Unrecognized or invalid _bsontype: ${String(value['_bsontype'])}`);
  ***REMOVED***
***REMOVED***
***REMOVED*** else if (object instanceof Map || isMap(object)) {
  ...
  ***REMOVED*** else if (type === 'bigint' || isBigInt64Array(value) || isBigUInt64Array(value)) {
        throw new BSONTypeError('Unsupported type BigInt, please use Decimal128');
