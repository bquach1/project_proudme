...
***REMOVED*** else if (typeof low === 'string') {
...
***REMOVED***
    ...
    if (!this.unsigned) {
      ...
      ***REMOVED***
    ***REMOVED***
  ***REMOVED*** else if (divisor.eq(Long.MIN_VALUE)) return this.unsigned ? Long.UZERO : Long.ZERO;
      if (this.isNegative()) {
...
***REMOVED*** else if (multiplier.isNegative()) return this.mul(multiplier.neg()).neg();
...
***REMOVED***
  ...
  ***REMOVED*** else if (numBits === 32) return Long.fromBits(high, 0, this.unsigned);
