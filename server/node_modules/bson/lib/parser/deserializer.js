...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
                ...
                if (!globalUTFValidation) {
                    objectOptions = __assign(__assign({}, options), { validation: { utf8: shouldValidateKey } ***REMOVED***
            ***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            if (!globalUTFValidation) {
                arrayOptions = __assign(__assign({}, arrayOptions), { validation: { utf8: shouldValidateKey } ***REMOVED***
        ***REMOVED***
