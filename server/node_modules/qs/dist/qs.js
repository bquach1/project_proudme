...
var parseObject = function (chain, val, options, valuesParsed) {
    ...
    ***REMOVED***
        ...
        ***REMOVED*** else if (
                ...
                obj = [];
                obj[index] = leaf;
        ***REMOVED*** else if (cleanRoot !== '__proto__') {
                obj[cleanRoot] = leaf;
        ***REMOVED***
    ***REMOVED***
...
***REMOVED*** else if (generateArrayPrefix === 'comma' && isArray(obj)) {
...
***REMOVED*** else if (isArray(filter)) {
        objKeys = filter;
***REMOVED***
...
module.exports = function (object, opts) {
    ...
    if (typeof options.filter === 'function') {
        ...
        obj = filter('', obj);
***REMOVED*** else if (isArray(options.filter)) {
        filter = options.filter;
        objKeys = filter;
***REMOVED***
...
***REMOVED*** else if (opts && 'indices' in opts) {
...
if ($defineProperty) {
	try {
		$defineProperty({}, 'a', { value: 1 ***REMOVED***
	} catch (e) {
...
***REMOVED***
    ...
    if (typeof seen === 'undefined') {
        seen = [];
***REMOVED*** else if (indexOf(seen, obj) >= 0) {
        return '[Circular]';
***REMOVED***
...
***REMOVED***
    if (typeof obj === 'object' && customInspect) {
        if (inspectSymbol && typeof obj[inspectSymbol] === 'function' && utilInspect) {
            return utilInspect(obj, { depth: maxDepth - depth ***REMOVED***
    ***REMOVED*** else if (customInspect !== 'symbol' && typeof obj.inspect === 'function') {
            return obj.inspect();
    ***REMOVED***
***REMOVED***
    if (isMap(obj)) {
...
function getIndent(opts, depth) {
    ...
    if (opts.indent === '\t') {
        baseIndent = '\t';
***REMOVED*** else if (typeof opts.indent === 'number' && opts.indent > 0) {
...
***REMOVED***
    ...
    ***REMOVED*** else if ($test.call(/[^\w$]/, key)) {
