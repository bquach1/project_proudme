...
const EatScreen = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row", alignItems: "center", textAlign: "center", overflow: "hidden"}}>
      <GoalContainer>
        <td style={styles.titleGroup}>
          ...
          />
          <h2 style={{ position: 'fixed', left: '20px', top: '220px' }}>Eating Fruits</h2>
        </td>
        <table>
          <td style = {styles.fullwidth}>
            <h3 style={{ position: 'fixed', left: '20px', top: '300px' }}>My goal</h3>
            <div style={{ width: "50%", position: 'fixed', left: '130px', top: '290px' }}>
              <Tooltip
                title={
