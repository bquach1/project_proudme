                                            ...
                                            <div className="goal-box">
                                                ...
                                                <div className="recommendation-container">
                                                    <div className="text-container">
                                                        ...
                                                        <div className="selection-container">
                                                            <h3>Eating</h3>
                                                            <p>Goals to change diet and eating habits.</p>
                                                        </div>
                                                    </div>

                                                    <div className="single-button-container">
                                                        <Button style={{
                                                            backgroundColor: '#78C648', textTransform: 'none', fontWeight: 'bold', fontSize: '18px',
                                                            borderRadius: '25px', color: 'white', width: '175px', marginTop: '5%'
                                                    ***REMOVED***}
                                                ...
                                                <div className="recommendation-container">
                                                    ...
                                                    <div className="text-container">
                                                        ...
                                                        <div className="selection-container">
                                                            <h3>Activity</h3>
                                                            <p>Goals to set exercise and fitness expectations.</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="recommendation-container">
                                                    ...
                                                    <div className="text-container">
                                                        ...
                                                        <div className="selection-container">
                                                            <h3>Screentime</h3>
                                                            <p>Goals to monitor and limit device usage.</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="recommendation-container">
                                                    ...
                                                    <div className="text-container">
                                                        ...
                                                        <div className="selection-container">
                                                            <h3>Sleep</h3>
                                                            <p>Goals to maximize and keep track of sleep patterns.</p>
                                                        </div>
                                                    </div>
