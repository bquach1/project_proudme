...
***REMOVED***
    return obj;
***REMOVED***, null);
  options = Object.assign({}, options, { priorDoc: priorVal ***REMOVED***
  if (init) {
    subdoc = new Constructor(void 0, selected, doc, false, { defaults: false ***REMOVED***
 ...
 *     const schema = Schema({ shape: shapeSchema ***REMOVED***
 *
