 ...
 *
 *     const M = mongoose.model({ buf: { type: Buffer, required: true } ***REMOVED***
 ...
 * #### Example:
 *
 *     const s = new Schema({ uuid: { type: Buffer, subtype: 4 ***REMOVED***
 *     const M = db.model('M', s);
 *     const m = new M({ uuid: 'test string' ***REMOVED***
 *     m.uuid._subtype; // 4
 *
