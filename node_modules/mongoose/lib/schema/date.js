 ...
 *
 *     // expire in 24 hours
 *     new Schema({ createdAt: { type: Date, expires: 60*60*24 }***REMOVED***
 *
 ...
 *
 *     // expire in 24 hours
 *     new Schema({ createdAt: { type: Date, expires: '24h' }***REMOVED***
 *
 *     // expire in 1.5 hours
 *     new Schema({ createdAt: { type: Date, expires: '1.5h' }***REMOVED***
 *
 *     // expire in 7 days
 *     const schema = new Schema({ createdAt: Date ***REMOVED***
 ...
 *     const s= new M({ d: Date('1969-12-31') ***REMOVED***
 ...
 *     const M = mongoose.model('M', schema);
 *     const s= new M({ d: Date('2014-12-08') ***REMOVED***
 *     s.validate(function (err) {
