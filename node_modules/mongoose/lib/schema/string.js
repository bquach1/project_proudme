 ...
 *
 *     const M = mongoose.model({ str: { type: String, required: true } ***REMOVED***
 ...
 *     const M = db.model('M', s);
 *     const m = new M({ email: 'SomeEmail@example.COM' ***REMOVED***
 ...
 *     // to lowercase.
 *     M.find({ email: /SomeEmail/ ***REMOVED***
 *
 * @api public
 * @return {SchemaType} this
 */
 ...
 *     const M = db.model('M', s);
 *     const m = new M({ caps: 'an example' ***REMOVED***
 ...
 *     M.find({ email: /an example/ ***REMOVED***
 *
 * @api public
 * @return {SchemaType} this
 */
 ...
 * #### Example:
 *
 *     const s = new Schema({ name: { type: String, trim: true }***REMOVED***
 *     const M = db.model('M', s);
 *     const string = ' some name ';
 *     console.log(string.length); // 11
 *     const m = new M({ name: string ***REMOVED***
 *     console.log(m.name.length); // 9
 *
 *     // Equivalent to `findOne({ name: string.trim() })`
 *     M.findOne({ name: string ***REMOVED***
 *
 ...
 *     const address = new Address({ postalCode: '9512' ***REMOVED***
 ...
 *     const Address = mongoose.model('Address', schema);
 *     const address = new Address({ postalCode: '9512512345' ***REMOVED***
 *     address.validate(function (err) {
 ...
 *     const M = db.model('M', s);
 *     const m = new M({ file: 'invalid' ***REMOVED***
 *     m.validate(function (err) {
...
***REMOVED*** else if (typeof this.constructor.cast === 'function') {
