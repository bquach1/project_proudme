...
const methods = {
  ...
  $__getAtomics() {
    const ret = [];
    const keys = Object.keys(this[arrayAtomicsSymbol] || {***REMOVED***
    let i = keys.length;

    const opts = Object.assign({}, internalToObjectOptions, { _isNested: true ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else if (val != null && typeof val.valueOf === 'function') {
        val = val.valueOf();
  ***REMOVED***
...
***REMOVED***,
   ...
   * #### Example:
   *
   *     const schema = Schema({ nums: [Number] ***REMOVED***
   *     const Model = mongoose.model('Test', schema);
   *
   *     const doc = await Model.create({ nums: [3, 4] ***REMOVED***
