 ...
 * #### Example:
 *
 *     const schema = new Schema({ users: [{ name: string }] ***REMOVED***
 ...
 * #### Example:
 *
 *     const childSchema = Schema({ name: { type: String, index: true } ***REMOVED***
 ...
 * #### Example:
 *
 *     const childSchema = Schema({ name: String ***REMOVED***
 *     const parentSchema = Schema({
