 ...
 * #### Example:
 *
 *     const schema = new Schema({ tags: [String] ***REMOVED***
 ...
 *     new Schema({ arr: [Number] ***REMOVED***
 *     // Equivalent way to define `arr` as an array of numbers
 *     new Schema({ arr: { type: Array, of: Number } ***REMOVED***
 *
 * @api public
 * @property of
 * @memberOf SchemaArrayOptions
 ...
 *     const doc = new Model({ x1: "some non-array value" ***REMOVED***
