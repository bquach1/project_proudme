...
***REMOVED***
    fields = undefined;
***REMOVED*** else if (schema.options.strict !== true) {
  ...
  if (!this.$__.strictMode && obj) {
    ...
    keys.forEach(function(key) {
      ...
      if (!(key in schema.tree) && !(key in schema.methods) && !(key in schema.virtuals) && !key.startsWith('$')) {
        defineKey({ prop: key, subprops: null, prototype: _this ***REMOVED***
  ***REMOVED***
    ***REMOVED***
***REMOVED***
 ...
 * #### Example:
 *
 *     const user = new User({ name: 'John Smith' ***REMOVED***
 *     user.$isNew; // true
 *
 ...
 * #### Example:
 *
 *     const user = await User.findOne({ name: 'John Smith' ***REMOVED***
 *     user.$isNew; // false
 *
 ...
 *       this.$isNew; // false
 *     ***REMOVED***
 *     await User.create({ name: 'John Smith' ***REMOVED***
 *
 ...
 *
 *     group.users.push({ name: 'John Smith' ***REMOVED***
 ...
 *
 *     new Schema({ name: String }, { id: false ***REMOVED***
 *
 * @api public
 ...
 * #### Example:
 *
 *     const doc = new Model({ name: 'test' ***REMOVED***
 *     doc.$op; // null
 *
...
***REMOVED***
  ...
  ***REMOVED*** else if (exclude === false && fields && !included) {
        if (curPath in fields) {
          included = true;
    ***REMOVED*** else if (!hasIncludedChildren[curPath]) {
          break;
    ***REMOVED***
  ***REMOVED***

      if (i < last) {
        doc_ = doc_[piece] || (doc_[piece] = {***REMOVED***
  ***REMOVED***
***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else if (obj[i] !== undefined) {
...
Document.prototype.update = function update() {
  ...
  args.unshift({ _id: this._id ***REMOVED***
 ...
 *     const doc = new TestModel({ name: 'John Smith' ***REMOVED***
 *
 *     doc.$timestamps(); // true
 *
...
***REMOVED***
  ...
  if (adhoc) {
    adhocs = this.$__.adhocPaths || (this.$__.adhocPaths = {***REMOVED***
    adhocs[path] = this.$__schema.interpretAsType(path, type, this.$__schema.options);
***REMOVED***

  if (path == null) {
    [path, val] = [val, path];
***REMOVED*** else if (typeof path !== 'string') {
...
***REMOVED***
    ...
    for (let i = 0; i < len; ++i) {
      ...
      if (type === true &&
        ...
        options = Object.assign({}, options, { _skipMinimizeTopLevel: true ***REMOVED***
  ***REMOVED***
        // Make sure we set `{_skipMinimizeTopLevel: false}` if don't have overwrite: gh-10441
        options = Object.assign({}, options, { _skipMinimizeTopLevel: false ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED*** else if (strict) {
    ...
    ***REMOVED***
        ...
        if (pathtype === 'adhocOrUndefined') {
          pathtype = getEmbeddedDiscriminatorPath(this, pathName, { typeOnly: true ***REMOVED***
    ***REMOVED***

        if (pathtype === 'real' || pathtype === 'virtual') {
          const p = path[key];
          this.$set(prefix + key, p, constructing, options);
    ***REMOVED*** else if (pathtype === 'nested' && path[key] instanceof Document) {
          this.$set(prefix + key,
            path[key].toObject({ transform: false }), constructing, options);
    ***REMOVED*** else if (strict === 'throw') {
          if (pathtype === 'nested') {
      ...
      ***REMOVED***
    ***REMOVED***
  ***REMOVED*** else if (path[key] !== void 0) {
...
***REMOVED***
  ...
  if (pathType === 'adhocOrUndefined') {
    pathType = getEmbeddedDiscriminatorPath(this, path, { typeOnly: true ***REMOVED***
***REMOVED***
...
***REMOVED***)();
  ...
  ***REMOVED***
      ...
      if (this.$__.savedState != null && !this.$isNew && !this.$__.savedState.hasOwnProperty(path)) {
        ...
        const keys = Object.keys(initialVal || {***REMOVED***
        for (const key of keys) {
...
***REMOVED***
  ...
  ***REMOVED***
      return this;
***REMOVED***
***REMOVED*** else if (pathType === 'virtual') {
...
***REMOVED***
  ...
  if (val != null && merge && schema.$isSingleNested) {
    if (val instanceof Document) {
      val = val.toObject({ virtuals: false, transform: false ***REMOVED***
***REMOVED***
...
***REMOVED***)();
    ...
    if (refMatches && val instanceof Document && (!val.$__.wasPopulated || utils.deepEqual(val.$__.wasPopulated.value, val._id))) {
      ...
      this.$populated(path, unpopulatedValue, { [populateModelSymbol]: val.constructor ***REMOVED***
...
***REMOVED***
    ...
    if (this.$__schema.singleNestedPaths[path] == null && (!refMatches || !schema.$isSingleNested || !val.$__)) {
      ...
      if (options != null && options.overwriteImmutable) {
        val = schema.applySetters(val, this, false, priorVal, { overwriteImmutable: true ***REMOVED***
  ***REMOVED***
...
***REMOVED*** else if (e instanceof MongooseError.CastError) {
 ...
 *     doc.set(path, value, { strict: false ***REMOVED***
 *
 * @param {String|Object} path path or object of key/vals to set
 * @param {Any} val the value to set
 * @param {Schema|String|Number|Buffer|*} [type] optionally specify a type for "on-the-fly" attributes
...
***REMOVED***
  ...
  ***REMOVED***
***REMOVED***
***REMOVED*** else if (Array.isArray(val) && Array.isArray(priorVal) && utils.isMongooseArray(val) && utils.isMongooseArray(priorVal)) {
    val[arrayAtomicsSymbol] = priorVal[arrayAtomicsSymbol];
    val[arrayAtomicsBackupSymbol] = priorVal[arrayAtomicsBackupSymbol];
    if (utils.isMongooseDocumentArray(val)) {
      val.forEach(doc => { doc.isNew = false; ***REMOVED***
***REMOVED***
***REMOVED***
...
***REMOVED***
      if (utils.isPOJO(obj[parts[i]])) {
        obj = obj[parts[i]];
  ***REMOVED*** else if (obj[parts[i]] && obj[parts[i]] instanceof Embedded) {
        obj = obj[parts[i]];
  ***REMOVED*** else if (obj[parts[i]] && !Array.isArray(obj[parts[i]]) && obj[parts[i]].$isSingleNested) {
        obj = obj[parts[i]];
  ***REMOVED*** else if (obj[parts[i]] && Array.isArray(obj[parts[i]])) {
        obj = obj[parts[i]];
  ***REMOVED***
 ...
 * #### Example:
 *
 *     const schema = new Schema({ counter: Number ***REMOVED***
 *     const Test = db.model('Test', schema);
 *
 *     const doc = await Test.create({ counter: 0 ***REMOVED***
 *     doc.$inc('counter', 2);
...
***REMOVED***
  ...
  if (schemaType == null) {
    if (this.$__.strictMode === 'throw') {
      throw new StrictModeError(path);
***REMOVED*** else if (this.$__.strictMode === true) {
      return this;
***REMOVED***
***REMOVED*** else if (schemaType.instance !== 'Number') {
...
***REMOVED***
    ...
    if (obj == null) {
      obj = void 0;
***REMOVED*** else if (obj instanceof Map) {
      obj = obj.get(pieces[i], { getters: false ***REMOVED***
***REMOVED*** else if (i === l - 1) {
...
***REMOVED*** else if (this.$__schema.nested[path] && options.virtuals) {
    // Might need to apply virtuals if this is a nested path
    return applyVirtuals(this, utils.clone(obj) || {}, { path: path ***REMOVED***
***REMOVED***
 ...
 * #### Example:
 *
 *     const schema = new Schema({ foo: String, nested: { bar: String } ***REMOVED***
 *     const Model = mongoose.model('Test', schema);
 *     await Model.create({ foo: 'original', nested: { bar: 'original' } ***REMOVED***
 *
 ...
 * #### Example:
 *
 *     const schema = new Schema({ nested: { foo: String } ***REMOVED***
 *     const Model = mongoose.model('Test', schema);
 *     const doc = new Model({***REMOVED***
 ...
 * #### Example:
 *
 *     MyModel = mongoose.model('test', { name: { type: String, default: 'Val '} ***REMOVED***
 *     const m = new MyModel();
...
***REMOVED*** else if (this.$__.validating) {
    parallelValidate = new ParallelValidateError(this, {
      parentStack: options && options.parentStack,
      conflictStack: this.$__.validating.stack
    ***REMOVED***
***REMOVED*** else {
    this.$__.validating = new ParallelValidateError(this, { parentStack: options && options.parentStack ***REMOVED***
***REMOVED***
...
***REMOVED*** else if (typeof arguments[0] === 'function') {
      callback = arguments[0];
      options = null;
      pathsToValidate = null;
***REMOVED***
***REMOVED*** else if (typeof pathsToValidate === 'function') {
...
***REMOVED***
    ...
    this.$__validate(pathsToValidate, options, (error) => {
      ...
      cb(error);
    ***REMOVED***
***REMOVED***, this.constructor.events);
};
...
***REMOVED***
    ...
    if (!_pathType.caster && _pathType.validators.length === 0) {
      paths.delete(path);
***REMOVED*** else if (_pathType.$isMongooseArray &&
  ...
  for (const pathToCheck of paths) {
    if (doc.$__schema.nested[pathToCheck]) {
      ...
      if (isMongooseObject(_v)) {
        _v = _v.toObject({ transform: false ***REMOVED***
  ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
      ...
      if ((pop = _this.$populated(path))) {
        val = pop;
  ***REMOVED*** else if (val != null && val.$__ != null && val.$__.wasPopulated) {
  ...
  ***REMOVED***;
    ...
    ***REMOVED***
        --total || complete();
  ***REMOVED***, scope, doValidateOptions);
    ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  for (const path of paths) {
    if (_pathsToValidate.has(path)) {
      ret.push(path);
***REMOVED*** else if (parentPaths.has(path)) {
...
***REMOVED*** else if (typeof pathsToSkip === 'string' && pathsToSkip.indexOf(' ') !== -1) {
...
***REMOVED***
  ...
  if (Array.isArray(pathsToValidate)) {
    paths = _handlePathsToValidate(paths, pathsToValidate);
***REMOVED*** else if (Array.isArray(pathsToSkip)) {
    paths = _handlePathsToSkip(paths, pathsToSkip);
***REMOVED***
  const validating = {};
...
Document.prototype.$__reset = function reset() {
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if (subdoc.$parent() != null && subdoc.$parent().$isSubdocument) {
...
***REMOVED***).reduce(function(seed, array) {
  ...
  function docReducer(doc, seed, path) {
    ...
    if (path) {
      if (doc instanceof Document && doc[documentSchemaSymbol].paths[path]) {
        val = doc._doc[path];
  ***REMOVED*** else if (doc instanceof Document && doc[documentSchemaSymbol].nested[path]) {
        val = doc._doc[path];
        isNested = true;
  ***REMOVED***
        val = doc[path];
...
***REMOVED***
    if (val instanceof Embedded) {
      seed.push(val);
***REMOVED*** else if (val instanceof Map) {
      seed = Array.from(val.keys()).reduce(function(seed, path) {
        return docReducer(val.get(path), seed, null);
  ***REMOVED***, seed);
***REMOVED*** else if (val && !Array.isArray(val) && val.$isSingleNested) {
      seed = Object.keys(val._doc).reduce(function(seed, path) {
        return docReducer(val, seed, path);
  ***REMOVED***, seed);
      seed.push(val);
***REMOVED*** else if (val && utils.isMongooseDocumentArray(val)) {
    ...
    ***REMOVED***
      ***REMOVED***
***REMOVED*** else if (isNested && val != null) {
...
Document.prototype.$__handleReject = function handleReject(err) {
  ...
  if (this.$listeners('error').length) {
    this.$emit('error', err);
***REMOVED*** else if (this.constructor.listeners && this.constructor.listeners('error').length) {
...
***REMOVED*** else if (defaultOptions.minimize != null) {
...
***REMOVED*** else if (defaultOptions.flattenMaps != null) {
 ...
 *     doc.toObject({ transform: xform ***REMOVED*** // { inline: 'Wreck-it Ralph', custom: true }
 *
 ...
 * ***REMOVED***
 *
 *     const doc = new Doc({ _id: 'anId', secret: 47, name: 'Wreck-it Ralph' ***REMOVED***
 *     doc.toObject();                                        // { secret: 47, name: 'Wreck-it Ralph' }
 *     doc.toObject({ hide: 'secret _id', transform: false ***REMOVED***// { _id: 'anId', secret: 47, name: 'Wreck-it Ralph' }
 *     doc.toObject({ hide: 'secret _id', transform: true ***REMOVED*** // { name: 'Wreck-it Ralph' }
 *
 ...
 *
 *     const memberSchema = new Schema({ name: String, email: String ***REMOVED***
 *     const groupSchema = new Schema({ members: [memberSchema], name: String, email ***REMOVED***
 ...
 *     doc.toObject({ transform: (doc, ret) => { delete ret.email; return ret; } ***REMOVED***
 *
...
***REMOVED***
  ...
  ***REMOVED*** else if (v == null) {
        if (part in cur) {
          branch[part] = v;
    ***REMOVED***
        break;
  ***REMOVED***
        branch = branch[part] || (branch[part] = {***REMOVED***
  ***REMOVED***
      cur = v;
***REMOVED***
***REMOVED***
...
function applySchemaTypeTransforms(self, json) {
  const schema = self.$__schema;
  const paths = Object.keys(schema.paths || {***REMOVED***
  const cur = self._doc;
...
***REMOVED*** else if (schematype.$embeddedSchemaType != null &&
 ...
 *
 *     schema.set('toJSON', { virtuals: true ***REMOVED***
 *
 ...
 *     await Story.delete({ title: 'Casino Royale' ***REMOVED***
...
***REMOVED*** else if (value instanceof Document) {
      result.push(value);
***REMOVED***
***REMOVED***
  return result;
...
***REMOVED***
  ...
  this.$__.populated || (this.$__.populated = {***REMOVED***
 ...
 *     doc.$assertPopulated('likes', { likes ***REMOVED***
 *
 *
