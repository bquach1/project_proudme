 ...
 * #### Example:
 *
 *     aggregate.append({ $project: { field: 1 }}, { $limit: 2 ***REMOVED***
 *
 *     // or pass an array
 ...
 *
 *     // etc
 *     aggregate.addFields({ salary_k: { $divide: [ "$salary", 1000 ] } ***REMOVED***
 *
...
***REMOVED***
  return this.append({ $addFields: Object.assign({}, arg) ***REMOVED***
};
 ...
 *     aggregate.project({a: 1, b: 1, _id: 0***REMOVED***
 *
 *     // reshaping documents
 *     aggregate.project({
 *         newField: '$b.nested'
 ...
 *
 *     // etc
 *     aggregate.project({ salary_k: { $divide: [ "$salary", 1000 ] } ***REMOVED***
 *
...
Aggregate.prototype.project = function(arg) {
  ...
  if (typeof arg === 'object' && !Array.isArray(arg)) {
    ...
    ***REMOVED***
***REMOVED*** else if (arguments.length === 1 && typeof arg === 'string') {
...
***REMOVED***
  ...
  return this.append({ $project: fields ***REMOVED***
};
 ...
 * #### Example:
 *
 *     aggregate.group({ _id: "$department" ***REMOVED***
 *
 ...
 * #### Example:
 *
 *     aggregate.match({ department: { $in: [ "sales", "engineering" ] } ***REMOVED***
 *
 ...
 *     aggregate.unwind({ path: '$tags', preserveNullAndEmptyArrays: true ***REMOVED***
 *
...
Aggregate.prototype.unwind = function() {
  ...
  for (const arg of args) {
    if (arg && typeof arg === 'object') {
      res.push({ $unwind: arg ***REMOVED***
***REMOVED*** else if (typeof arg === 'string') {
      res.push({
 ...
 *
 *     aggregate.replaceRoot({ x: { $concat: ['$this', '$that'] } ***REMOVED***
 *
...
Aggregate.prototype.count = function(fieldName) {
  return this.append({ $count: fieldName ***REMOVED***
};
...
Aggregate.prototype.sortByCount = function(arg) {
  if (arg && typeof arg === 'object') {
    return this.append({ $sortByCount: arg ***REMOVED***
***REMOVED*** else if (typeof arg === 'string') {
    return this.append({
 ...
 * #### Example:
 *
 *     aggregate.lookup({ from: 'users', localField: 'userId', foreignField: '_id', as: 'users' ***REMOVED***
 *
...
Aggregate.prototype.lookup = function(options) {
  return this.append({ $lookup: options ***REMOVED***
};
...
***REMOVED***
  return this.append({ $graphLookup: cloneOptions ***REMOVED***
};
...
Aggregate.prototype.sample = function(size) {
  return this.append({ $sample: { size: size } ***REMOVED***
};
 ...
 *     aggregate.sort({ field: 'asc', test: -1 ***REMOVED***
...
***REMOVED***
  ...
  return this.append({ $sort: sort ***REMOVED***
};
 ...
 * #### Example:
 *
 *     aggregate.unionWith({ coll: 'users', pipeline: [ { $match: { _id: 1 } } ] ***REMOVED***
 *
...
Aggregate.prototype.unionWith = function(options) {
  return this.append({ $unionWith: options ***REMOVED***
};
...
***REMOVED***
  ...
  return this.append({ $redact: expression ***REMOVED***
};
 ...
 * #### Example:
 *
 *     const agg = Model.aggregate(..).option({ allowDiskUse: true ***REMOVED*** // Set the `allowDiskUse` option
 ...
 * #### Example:
 *
 *     const cursor = Model.aggregate(..).cursor({ batchSize: 1000 ***REMOVED***
 ...
 * #### Example:
 *
 *     const res = await Model.aggregate(pipeline).collation({ locale: 'en_US', strength: 1 ***REMOVED***
 *
...
Aggregate.prototype.facet = function(options) {
  return this.append({ $facet: options ***REMOVED***
};
...
Aggregate.prototype.search = function(options) {
  return this.append({ $search: options ***REMOVED***
};
...
***REMOVED***
  ...
  ***REMOVED***
      ...
      const options = utils.clone(this.options || {***REMOVED***
