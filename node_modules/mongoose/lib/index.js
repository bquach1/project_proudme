 ...
 *
 *     mongoose.set('debug', function(collectionName, methodName, ...methodArgs) {***REMOVED*** // use custom function to log collection methods + arguments
 *
 *     mongoose.set({ debug: true, autoIndex: false ***REMOVED*** // set multiple options at once
 *
 ...
 *
 *     mongoose.isValidObjectId({ test: 42 ***REMOVED*** // false
 *
 ...
 *     mongoose.isObjectIdOrHexString({ test: 42 ***REMOVED*** // false
 *
 ...
 * #### Example:
 *
 *     const schema = new Schema({ test: Date ***REMOVED***
 ...
 * #### Example:
 *
 *     const schema = new Schema({ num: mongoose.Number ***REMOVED***
 *     // Equivalent to:
 *     const schema = new Schema({ num: 'number' ***REMOVED***
 *
 * @property Number
 * @api public
 */
 ...
 * sanitizeFilter(obj);
 * obj; // { username: 'val', pwd: { $eq: { $ne: null } } ***REMOVED***
 * ```
 *
 ...
 * obj; // { username: 'val', pwd: { $type: 'string', $eq: 'my secret' } ***REMOVED***
 * ```
 *
 * @method trusted
 * @param {Object} obj
 ...
 *       return mongoose.skipMiddlewareFunction({ matchedCount: 0 ***REMOVED***
 *     ***REMOVED***
 *
