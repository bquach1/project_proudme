 ...
 *     query.setOptions({ lean : true ***REMOVED***
 ...
 *       get: function () {
 *         this.where({ rating: { $gt: 4.5 }***REMOVED***
 *         return this;
 *   ***REMOVED***
 * ***REMOVED***)
 ...
 * #### Example:
 *
 *     const q = Book.findOne({ title: 'Casino Royale' ***REMOVED***
 *     await q.exec();
...
Query.prototype.mod = function() {
  ...
  if (arguments.length === 1) {
    ...
    val = arguments[0];
    path = this._path;
***REMOVED*** else if (arguments.length === 2 && !Array.isArray(arguments[1])) {
    this._ensurePath('mod');
    val = [arguments[0], arguments[1]];
    path = this._path;
***REMOVED*** else if (arguments.length === 3) {
...
***REMOVED***
  ...
  const conds = this._conditions[path] || (this._conditions[path] = {***REMOVED***
  conds.$mod = val;
  return this;
};
 ...
 *     query.select({ a: 1, b: 1 ***REMOVED***
 *     query.select({ c: 0, d: 0 ***REMOVED***
 *
 *     Additional calls to select can override the previous selection:
 *     query.select({ a: 1, b: 1 }).select({ b: 0 ***REMOVED*** // selection is now { a: 1 }
 *     query.select({ a: 0, b: 0 }).select({ b: 1 ***REMOVED*** // selection is now { a: 0 }
 *
 *
 * @method select
 * @memberOf Query
...
***REMOVED***
  ...
  const fields = this._fields || (this._fields = {***REMOVED***
  const userProvidedFields = this._userProvidedFields || (this._userProvidedFields = {***REMOVED***
...
***REMOVED*** else if (this.model != null && utils.hasUserDefinedProperty(this.model.base.options, 'sanitizeProjection')) {
...
***REMOVED***
  ...
  if (utils.isObject(arg)) {
    ...
    ***REMOVED***
      ***REMOVED***
***REMOVED*** else if (this.selectedExclusively()) {
      Object.entries(arg).forEach(([key, value]) => {
        if (!value) {
          // Add the field to the projection
          fields[key] = userProvidedFields[key] = sanitizeValue(value);
 ...
 *       writeConcern({ w: 'majority' ***REMOVED***
 *
 * @method writeConcern
 * @memberOf Query
 * @instance
 ...
 *     query.limit(10);
 *     query.setOptions({ maxTimeMS: 1000 ***REMOVED***
 ...
 *     const query = new Query();
 *     query.update({}, { $set: { a: 5 } ***REMOVED***
 *     query.setUpdate({ $set: { b: 6 } ***REMOVED***
 ...
 *     new Query().updateMany({}, {}).set({ updatedAt: new Date() ***REMOVED***
 *
 ...
 * #### Example:
 *
 *     const query = Model.updateOne({}, { $set: { name: 'Jean-Luc Picard' } ***REMOVED***
 ...
 * #### Example:
 *
 *     const TestSchema = new Schema({ num: Number ***REMOVED***
...
***REMOVED*** else if (this.model != null && utils.hasUserDefinedProperty(this.model.base.options, 'sanitizeFilter')) {
 ...
 *
 *     // Using async/await
 *     const arr = await Movie.find({ year: { $gte: 1980, $lte: 1989 } ***REMOVED***
 *
 *     // Using callbacks
 *     Movie.find({ year: { $gte: 1980, $lte: 1989 } }, function(err, arr) {***REMOVED***
 *
...
***REMOVED*** else if (conditions != null) {
...
***REMOVED***
    ...
    return this;
***REMOVED*** else if (this.model != null && source instanceof this.model.base.Types.ObjectId) {
 ...
 * #### Example:
 *
 *     const query  = Kitten.where({ color: 'white' ***REMOVED***
...
Query.prototype.distinct = function(field, conditions, callback) {
  ...
  if (!callback) {
    if (typeof conditions === 'function') {
      callback = conditions;
      conditions = undefined;
***REMOVED*** else if (typeof field === 'function') {
      callback = field;
      field = undefined;
      conditions = undefined;
***REMOVED***
 ...
 * #### Example:
 *
 *     const res = await Character.remove({ name: /Stark/ ***REMOVED***
 ...
 *
 *     // not executed
 *     const query = Character.remove({ name: /Stark/ ***REMOVED***
 *
 *     // executed
 *     Character.remove({ name: /Stark/ }, callback);
 ...
 * #### Example:
 *
 *     await Character.deleteOne({ name: 'Eddard Stark' ***REMOVED***
 *
 *     // Using callbacks:
 ...
 * #### Example:
 *
 *     const res = await Character.deleteOne({ name: 'Eddard Stark' ***REMOVED***
 ...
 * #### Example:
 *
 *     await Character.deleteMany({ name: /Stark/, age: { $gte: 18 } ***REMOVED***
 *
 *     // Using callbacks:
 ...
 * #### Example:
 *
 *     const res = await Character.deleteMany({ name: /Stark/, age: { $gte: 18 } ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
          ...
          return this;
    ***REMOVED***
  ***REMOVED*** else if (this._update instanceof Error) {
...
***REMOVED***
***REMOVED*** else if (Array.isArray(doc)) {
    if (!Array.isArray(this._update)) {
      throw new Error('Cannot mix array and object updates');
***REMOVED***
...
***REMOVED***
    ...
    if (this._update == null || Object.keys(this._update).length === 0) {
      callback(null, { acknowledged: false ***REMOVED***
      return null;
***REMOVED***
 ...
 * #### Example:
 *
 *     Model.where({ _id: id }).update({ title: 'words' ***REMOVED***
 *
 *     // becomes
 *
 *     Model.where({ _id: id }).update({ $set: { title: 'words' }***REMOVED***
 *
 * #### Valid options:
 *
 ...
 *
 * ```javascript
 * const q = Model.where({ _id: id ***REMOVED***
...
Query.prototype.update = function(conditions, doc, options, callback) {
  if (typeof options === 'function') {
    ...
    callback = options;
    options = null;
***REMOVED*** else if (typeof doc === 'function') {
    // .update(doc, callback);
    callback = doc;
    doc = conditions;
    conditions = {};
...
***REMOVED*** else if (typeof conditions === 'function') {
    ...
    doc = undefined;
    options = undefined;
***REMOVED*** else if (typeof conditions === 'object' && !doc && !options && !callback) {
    // .update(doc)
    doc = conditions;
    conditions = undefined;
    options = undefined;
 ...
 *       return res == null ?
 *         res :
 *         Object.assign(res, { loadedAt: new Date() ***REMOVED***
 *     ***REMOVED***
 *
 * @method transform
 * @memberOf Query
...
Query.prototype.exec = function exec(op, callback) {
  ...
  if (typeof op === 'function') {
    callback = op;
    op = null;
***REMOVED*** else if (typeof op === 'string') {
    this.op = op;
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
      ...
      if (this.op === 'update') {
        thunk = '_execUpdate';
  ***REMOVED*** else if (this.op === 'distinct') {
        thunk = '__distinct';
  ***REMOVED***
 ...
 * #### Example:
 *
 *     const q1 = Question.find({ answer: 42 ***REMOVED***
 ...
 *     // registered on `q1`.
 *     await Question.find({ answer: 42 ***REMOVED***
 *
 * @param {Function} fn
 * @return {Promise}
 * @api public
 ...
 *       on('end', function() { console.log('Done!'); ***REMOVED***
 *
...
Query.prototype.cursor = function cursor(opts) {
  this._applyPaths();
  this._fields = this._castFields(this._fields);
  this.setOptions({ projection: this._fieldsForExec() ***REMOVED***
  if (opts) {
 ...
 *     query.tailable({ awaitData: true ***REMOVED***
 *
 * #### Note:
 *
 * Cannot be used with `distinct()`
...
Query.prototype.near = function() {
  ...
  if (arguments.length === 1) {
    if (Array.isArray(arguments[0])) {
      params.push({ center: arguments[0], spherical: sphere ***REMOVED***
...
***REMOVED*** else if (arguments.length === 2) {
    if (typeof arguments[0] === 'number' && typeof arguments[1] === 'number') {
      params.push({ center: [arguments[0], arguments[1]], spherical: sphere ***REMOVED***
***REMOVED*** else if (typeof arguments[0] === 'string' && Array.isArray(arguments[1])) {
      params.push(arguments[0]);
      params.push({ center: arguments[1], spherical: sphere ***REMOVED***
***REMOVED*** else if (typeof arguments[0] === 'string' && utils.isObject(arguments[1])) {
      params.push(arguments[0]);
...
***REMOVED*** else if (arguments.length === 3) {
    if (typeof arguments[0] === 'string' && typeof arguments[1] === 'number'
      ...
      params.push(arguments[0]);
      params.push({ center: [arguments[1], arguments[2]], spherical: sphere ***REMOVED***
***REMOVED***
      throw new TypeError('invalid argument');
***REMOVED***
***REMOVED*** else {
 ...
 * #### Example:
 *
 *     query.where('loc').nearSphere({ center: [10, 10], maxDistance: 5 ***REMOVED***
 *
 * **Deprecated.** Use `query.near()` instead with the `spherical` option set to `true`.
 *
 * #### Example:
 *
 *     query.where('loc').near({ center: [10, 10], spherical: true ***REMOVED***
 *
 * @deprecated
