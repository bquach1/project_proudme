 ...
 * #### Example:
 *
 *     const doc = new Person({ name: 'Will Riker' ***REMOVED***
 *     await db.transaction(async function setRank(session) {
 *       doc.rank = 'Captain';
 *       await doc.save({ session ***REMOVED***
 *       doc.isNew; // false
 *
 *       // Throw an error to abort the transaction
 *       throw new Error('Oops!');
 * ***REMOVED***,{ readPreference: 'primary' }).catch(() => {***REMOVED***
 *
    ...
    return promiseOrCallback(cb, cb => {
      immediate(() => {
        if ((this.readyState === STATES.connecting || this.readyState === STATES.disconnected) && this._shouldBufferCommands()) {
          this._queue.push({ fn: fn, ctx: this, args: argsWithoutCb.concat([cb]) ***REMOVED***
    ***REMOVED*** else if (this.readyState === STATES.disconnected && this.db == null) {
...
***REMOVED***;
  ...
  ***REMOVED***
    ***REMOVED***
***REMOVED*** else if (type.startsWith('ReplicaSet')) {
    client.on('topologyDescriptionChanged', ev => {
      ...
      if (conn.readyState === STATES.connected && description.type !== 'ReplicaSetWithPrimary') {
        ...
        conn.readyState = STATES.disconnected;
  ***REMOVED*** else if (conn.readyState === STATES.disconnected && description.type === 'ReplicaSetWithPrimary') {
        _handleReconnect();
  ***REMOVED***
    ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  for (const db of this.otherDbs) {
    this._destroyCalled ? db.destroy({ force: force, skipCloseClient: true }) : db.close({ force: force, skipCloseClient: true ***REMOVED***
***REMOVED***
};
...
***REMOVED***;
  options = Object.assign({}, defaultOptions, options ? utils.clone(options) : {***REMOVED***
 ...
 * #### Example:
 *
 *     const schema = new Schema({ name: String }, { collection: 'actor' ***REMOVED***
 *
 *     // or
 *
...
***REMOVED*** else if (!(schema instanceof this.base.Schema)) {
...
***REMOVED***
  ...
  const opts = Object.assign(defaultOptions, options, { connection: this ***REMOVED***
 ...
 *     await User.create({ name: 'test' ***REMOVED***
 *
 * @api public
 ...
 *     const db2 = conn.useDb('mydb2', { useCache: true ***REMOVED***
 *
 * @method useDb
 * @memberOf Connection
