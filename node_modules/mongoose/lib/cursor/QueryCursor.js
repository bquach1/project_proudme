...
function QueryCursor(query, options) {
  ...
  Readable.call(this, { autoDestroy: true, objectMode: true ***REMOVED***
 ...
 *        return doc;
 *   ***REMOVED***)
 *       on('data', function(doc) { console.log(doc.foo); ***REMOVED***
 *
...
***REMOVED***
  ...
  ***REMOVED*** else if (ctx._batchExhausted) {
