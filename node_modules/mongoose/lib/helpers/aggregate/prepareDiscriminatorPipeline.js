...
***REMOVED*** else if (originalPipeline[0] != null && originalPipeline[0].$geoNear) {
      originalPipeline[0].$geoNear.query =
          originalPipeline[0].$geoNear.query || {};
      originalPipeline[0].$geoNear.query[filterKey] = discriminatorValue;
***REMOVED*** else if (originalPipeline[0] != null && originalPipeline[0].$search) {
  ...
  ***REMOVED***
        ...
        originalPipeline.splice(1, 0, { $match: match ***REMOVED***
  ***REMOVED***
***REMOVED***
      const match = {};
      match[filterKey] = discriminatorValue;
      originalPipeline.unshift({ $match: match ***REMOVED***
***REMOVED***
***REMOVED***
};
