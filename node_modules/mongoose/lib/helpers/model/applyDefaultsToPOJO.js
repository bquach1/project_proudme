...
module.exports = function applyDefaultsToPOJO(doc, schema) {
  ...
  ***REMOVED***
      ...
      ***REMOVED*** else if (type.$isMongooseDocumentArray && Array.isArray(doc_[piece])) {
    ...
    ***REMOVED***
        ...
        const def = type.getDefault(doc, false, { skipCast: true ***REMOVED***
        if (typeof def !== 'undefined') {
          doc_[piece] = def;

          if (type.$isSingleNested) {
            applyDefaultsToPOJO(def, type.caster.schema);
      ***REMOVED*** else if (type.$isMongooseDocumentArray && Array.isArray(def)) {
