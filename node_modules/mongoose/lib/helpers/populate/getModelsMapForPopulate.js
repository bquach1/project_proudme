...
***REMOVED*** else if (schema && !schema[schemaMixedSymbol]) {
...
***REMOVED***
  ...
  ***REMOVED*** else if (schemaForCurrentDoc != null) {
  ...
  ***REMOVED***
    ...
    ***REMOVED***
          ...
          modelNames = [ref];
    ***REMOVED***
  ***REMOVED*** else if ((schemaForCurrentDoc = get(schema, 'options.refPath')) != null) {
        isRefPath = true;
        if (typeof refPath === 'function') {
          const subdocPath = options.path.slice(0, options.path.length - schemaForCurrentDoc.path.length - 1);
          const vals = mpath.get(subdocPath, doc, lookupLocalFields);
...
***REMOVED*** else if (typeof virtual.options.localField === 'function') {
      localField = virtualPrefix + virtual.options.localField.call(doc, doc);
***REMOVED*** else if (Array.isArray(virtual.options.localField)) {
...
***REMOVED***
    ...
    if (virtual.options.refPath) {
      ...
      data.isRefPath = true;
***REMOVED*** else if (virtual.options.ref) {
      let normalizedRef;
...
***REMOVED***
    ...
    if (options.model && options.model[modelSymbol]) {
      Model = options.model;
***REMOVED*** else if (modelName[modelSymbol]) {
      Model = modelName;
***REMOVED***
    ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else if (schemaOptions != null) {
...
function _getLocalFieldValues(doc, localField, model, options, virtual, schema) {
  ...
  const _populateOptions = get(options, 'options', {***REMOVED***
