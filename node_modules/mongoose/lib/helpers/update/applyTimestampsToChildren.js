...
***REMOVED***
  ...
  for (let i = pieces.length - 1; i > 0; --i) {
    ...
    if (s != null &&
      ...
      parentSchemaTypes.push({ parentPath: key.split('.').slice(0, i).join('.'), parentSchemaType: s ***REMOVED***
***REMOVED***
***REMOVED***

  if (Array.isArray(update[key]) && path.$isMongooseDocumentArray) {
    applyTimestampsToDocumentArray(update[key], path, now);
***REMOVED*** else if (update[key] && path.$isSingleNested) {
    applyTimestampsToSingleNested(update[key], path, now);
***REMOVED*** else if (parentSchemaTypes.length > 0) {
  ...
  ***REMOVED*** else if (parentSchemaType.$isMongooseDocumentArray) {
  ...
  ***REMOVED***
***REMOVED***
***REMOVED*** else if (path.schema != null && path.schema != schema && update[key]) {
    const timestamps = path.schema.options.timestamps;
    const createdAt = handleTimestampOption(timestamps, 'createdAt');
    const updatedAt = handleTimestampOption(timestamps, 'updatedAt');
