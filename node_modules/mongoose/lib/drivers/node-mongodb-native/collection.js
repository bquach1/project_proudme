...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***, []);
  ***REMOVED*** else if (typeof lastArg === 'function') {
  ...
  ***REMOVED***
      ...
      timeout = setTimeout(() => {
        ...
        if (removed) {
          ...
          this.conn.emit('buffer-end', { _id: opId, modelName: _this.modelName, collectionName: _this.name, method: i, error: err ***REMOVED***
          callback(err);
    ***REMOVED***
  ***REMOVED***, bufferTimeoutMS);
  ...
  ***REMOVED***
      ...
      return promise;
***REMOVED*** else if (!syncCollectionMethods[i] && typeof lastArg === 'function') {
      callback = function collectionOperationCallback(err, res) {
        if (err != null) {
          _this.conn.emit('operation-end', { _id: opId, modelName: _this.modelName, collectionName: _this.name, method: i, error: err ***REMOVED***
    ***REMOVED***
          _this.conn.emit('operation-end', { _id: opId, modelName: _this.modelName, collectionName: _this.name, method: i, result: res ***REMOVED***
    ***REMOVED***
        return lastArg.apply(this, arguments);
  ***REMOVED***;
      _args = args.slice(0, args.length - 1).concat([callback]);
...
***REMOVED***
    ...
    this.conn.emit('operation-start', { _id: opId, modelName: _this.modelName, collectionName: this.name, method: i, params: _args ***REMOVED***
  ...
  ***REMOVED***
      ...
      if (ret != null && typeof ret.then === 'function') {
        return ret.then(
          res => {
            this.conn.emit('operation-end', { _id: opId, modelName: this.modelName, collectionName: this.name, method: i, result: res ***REMOVED***
            return res;
      ***REMOVED***,
          err => {
            this.conn.emit('operation-end', { _id: opId, modelName: this.modelName, collectionName: this.name, method: i, error: err ***REMOVED***
            throw err;
      ***REMOVED***
        );
  ***REMOVED***
...
***REMOVED*** catch (error) {
  ...
  ***REMOVED***
        this.conn.emit('operation-end', { _id: opId, modelName: _this.modelName, collectionName: this.name, method: i, error: error ***REMOVED***
...
***REMOVED***
  ...
  let x = clone(obj, { transform: false ***REMOVED***
  const constructorName = getConstructorName(x);

  if (constructorName === 'Binary') {
    x = 'BinData(' + x.sub_type + ', "' + x.toString('base64') + '")';
***REMOVED*** else if (constructorName === 'ObjectID') {
    x = inspectable('ObjectId("' + x.toHexString() + '")');
***REMOVED*** else if (constructorName === 'Date') {
    x = inspectable('new Date("' + x.toUTCString() + '")');
***REMOVED*** else if (constructorName === 'Object') {
    ...
    ***REMOVED*** else if (_constructorName === 'Object') {
          x[key] = format(x[key], true);
    ***REMOVED*** else if (_constructorName === 'ObjectID') {
          formatObjectId(x, key);
    ***REMOVED*** else if (_constructorName === 'Date') {
          formatDate(x, key, shell);
    ***REMOVED*** else if (_constructorName === 'ClientSession') {
