 ...
 * #### Example:
 *
 *     const child = new Schema({ name: String ***REMOVED***
 *     const schema = new Schema({ name: String, age: Number, children: [child] ***REMOVED***
 ...
 * #### Example:
 *
 *     const schema = new Schema({***REMOVED***
 ...
 * #### Example:
 *
 *     const schema = new Schema({ a: String }).add({ b: String ***REMOVED***
 *     schema.obj; // { a: String }
 *
 * @api public
 * @property obj
 ...
 * #### Example:
 *
 *     const schema = new Schema({ name: String }, { _id: false ***REMOVED***
 *     schema.paths; // { name: SchemaString { ... } }
 *
 *     schema.add({ age: Number ***REMOVED***
...
Schema.prototype._clone = function _clone(Constructor) {
  ...
  s.callQueue = this.callQueue.map(function(f) { return f; ***REMOVED***
 ...
 * #### Example:
 *
 *     const schema = Schema({ name: String, age: Number ***REMOVED***
...
***REMOVED***
  ...
  for (const path of paths) {
    if (this.nested[path]) {
      newSchema.add({ [path]: get(this.tree, path) ***REMOVED***
***REMOVED***
      const schematype = this.path(path);
      if (schematype == null) {
        throw new MongooseError('Path `' + path + '` is not in the schema');
  ***REMOVED***
      newSchema.add({ [path]: schematype ***REMOVED***
***REMOVED***
***REMOVED***
 ...
 * #### Example:
 *
 *     const eventSchema = new mongoose.Schema({ timestamp: Date }, { discriminatorKey: 'kind' ***REMOVED***
 *
 *     const clickedEventSchema = new mongoose.Schema({ element: String }, { discriminatorKey: 'kind' ***REMOVED***
 ...
 *
 *     const doc = await Event.create({ kind: 'clicked', element: '#hero' ***REMOVED***
 *     doc.element; // '#hero'
...
Schema.prototype.discriminator = function(name, schema) {
  this._applyDiscriminators = Object.assign(this._applyDiscriminators || {}, { [name]: schema ***REMOVED***
 ...
 *     ToySchema.add({ name: 'string', color: 'string', price: 'number' ***REMOVED***
 *
 *     const TurboManSchema = new Schema();
 *     // You can also `add()` another schema and copy over all paths, virtuals,
 *     // getters, setters, indexes, methods, and statics.
 *     TurboManSchema.add(ToySchema).add({ year: Number ***REMOVED***
 *
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
  ***REMOVED*** else if (val[0] != null && val[0].instanceOfSchema && utils.isPOJO(val[0]._applyDiscriminators)) {
  ...
  ***REMOVED***
    ...
    ***REMOVED***
  ***REMOVED***
***REMOVED*** else if (Object.keys(val).length < 1) {
      // Special-case: {} always interpreted as Mixed path so leaf at this node
      if (prefix) {
        this.nested[prefix.substring(0, prefix.length - 1)] = true;
  ***REMOVED***
      this.path(fullPath, val); // mixed type
***REMOVED*** else if (!val[typeKey] || (typeKey === 'type' && isPOJO(val.type) && val.type.type)) {
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        const schemaWrappedPath = Object.assign({}, val, { type: _schema ***REMOVED***
 ...
 * #### Example:
 *
 *     const toySchema = new Schema({ n: String ***REMOVED***
 *
 *     // Make 'name' an alias for 'n'
 *     toySchema.alias('n', 'name');
 *
 *     const Toy = mongoose.model('Toy', toySchema);
 *     const turboMan = new Toy({ n: 'Turbo Man' ***REMOVED***
 *
...
Schema.prototype.alias = function alias(path, alias) {
  aliasFields(this, { [path]: alias ***REMOVED***
  return this;
};
 ...
 * #### Example:
 *
 *     const ToySchema = new Schema({ name: String, color: String, price: Number ***REMOVED***
 *
 *     // Add a new index on { name, color }
 *     ToySchema.index({ name: 1, color: 1 ***REMOVED***
 *
 *     // Remove index on { name, color }
 *     // Keep in mind that order matters! `removeIndex({ color: 1, name: 1 })` won't remove the index
 *     ToySchema.removeIndex({ name: 1, color: 1 ***REMOVED***
 *
 *     // Add an index with a custom name
 *     ToySchema.index({ color: 1 }, { name: 'my custom index name' ***REMOVED***
 ...
 *
 *     const ToySchema = new Schema({ name: String, color: String, price: Number ***REMOVED***
 *     ToySchema.index({ name: 1 ***REMOVED***
 *     ToySchema.index({ color: 1 ***REMOVED***
 *
...
***REMOVED***
    ...
    ***REMOVED***
***REMOVED*** else if (schemaType.$isMongooseDocumentArray) {
    Object.defineProperty(schemaType.schema, 'base', {
      configurable: true,
      enumerable: false,
      writable: false,
...
function gatherChildSchemas(schema) {
  ...
  for (const path of Object.keys(schema.paths)) {
    ...
    if (schematype.$isMongooseDocumentArray || schematype.$isSingleNested) {
      childSchemas.push({ schema: schematype.schema, model: schematype.caster ***REMOVED***
***REMOVED***
***REMOVED***
...
***REMOVED*** else if (utils.isPOJO(castFromTypeKey)) {
    ...
    ***REMOVED*** else if (Schema.Types.DocumentArray.defaultOptions._id != null) {
...
***REMOVED***
  ...
  if (Buffer.isBuffer(type)) {
    name = 'Buffer';
***REMOVED*** else if (typeof type === 'function' || typeof type === 'object') {
    name = type.schemaName || utils.getFunctionName(type);
***REMOVED*** else if (type === Types.ObjectId) {
    name = 'ObjectId';
***REMOVED*** else if (type === Types.Decimal128) {
    name = 'Decimal128';
***REMOVED*** else {
...
***REMOVED*** else if (utils.isPOJO(obj.of)) {
 ...
 * #### Example:
 *
 *     const userSchema = new Schema({ name: String, registeredAt: Date ***REMOVED***
 ...
 * #### Example:
 *
 *     const s = new Schema({ name: String, nested: { foo: String } ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else if (val instanceof MongooseTypes.Array) {
 ...
 *     new Model({ name: 'test' ***REMOVED*** // Prints '{"_id": ..., "name": "test" }'
 *
 ...
 * #### Example:
 *
 *     const toySchema = new Schema({ name: String, created: Date ***REMOVED***
 *
 ...
 * #### Example:
 *
 *     const s = new Schema({ name: String ***REMOVED***
 ...
 *
 *     const s = new Schema({ name: String ***REMOVED***
 *     s.plugin((schema, opts) => console.log(opts.text, schema.path('name').path), { text: "Schema Path Name:" ***REMOVED***
...
***REMOVED***
***REMOVED***
  this.plugins.push({ fn: fn, opts: opts ***REMOVED***
 ...
 *       return this.find({ name: name ***REMOVED***
 *     ***REMOVED***
 *
  ...
  switch (key) {
    ...
    case '_id':
      ...
      if (value && !this.paths['_id']) {
        addAutoId(this);
  ***REMOVED*** else if (!value && this.paths['_id'] != null && this.paths['_id'].auto) {
        this.remove('_id');
  ***REMOVED***
      break;
    default:
 ...
 * #### Example:
 *
 *     const schema = new Schema({ name: String, age: Number ***REMOVED***
 *     schema.remove('name');
 ...
 * const userSchema = new Schema({ email: String ***REMOVED***
 * class UserClass {
 ...
 *     return this.findOne({ email ***REMOVED***
 * ***REMOVED***
 * }
 *
  ...
  function search(parts, schema) {
    ...
    while (p--) {
      ...
      ***REMOVED***
        ...
        ***REMOVED***
      ***REMOVED***
    ***REMOVED*** else if (foundschema.$isSchemaMap) {
          if (p >= parts.length) {
            return foundschema;
      ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else if (p === parts.length && schema.nested[trypath]) {
