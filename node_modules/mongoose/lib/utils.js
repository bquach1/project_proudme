...
***REMOVED***
  ...
  if (a.$__ != null) {
    a = a._doc;
***REMOVED*** else if (isMongooseObject(a)) {
    a = a.toObject();
***REMOVED***

  if (b.$__ != null) {
    b = b._doc;
***REMOVED*** else if (isMongooseObject(b)) {
    b = b.toObject();
***REMOVED***
  ...
  ***REMOVED***
      if (from[key] != null) {
        ...
        if (options.isDiscriminatorSchemaMerge &&
          ...
          continue;
    ***REMOVED*** else if (from[key].instanceOfSchema) {
      ...
      ***REMOVED***
          continue;
    ***REMOVED*** else if (isBsonType(from[key], 'ObjectID')) {
...
***REMOVED*** else if (obj.populate != null && typeof obj.populate === 'object') {
...
exports.array.unique = function(arr) {
  ...
  ***REMOVED***
      ret.push(item);
      primitives.add(item);
***REMOVED*** else if (isBsonType(item, 'ObjectID')) {
...
exports.warn = function warn(message) {
  return process.emitWarning(message, { code: 'MONGOOSE' ***REMOVED***
};
