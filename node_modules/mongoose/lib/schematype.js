 ...
 * #### Example:
 *
 *     const schema = new Schema({ name: { type: String, required: true } ***REMOVED***
 ...
 *     // Disallow `null` for numbers, and don't try to cast any values to
 *     // numbers, so even strings like '123' will cause a CastError.
 *     const number = new mongoose.Number('mypath', {***REMOVED***
 ...
 *     mongoose.Number.get(function(v) { return Math.floor(v); ***REMOVED***
 *
 ...
 *     const schema = new Schema({ mixed: Schema.Types.Mixed ***REMOVED***
 ...
 *     s.path('my.date').index({ expires: 60 ***REMOVED***
 *     s.path('my.path').index({ unique: true, sparse: true ***REMOVED***
 *
 * #### Note:
 *
 ...
 * #### Example:
 *
 *     const s = new Schema({ name: { type: String, unique: true } ***REMOVED***
 *     s.path('name').index({ unique: true ***REMOVED***
 *
 ...
 *      s.path('name').index({ text : true ***REMOVED***
 *
 * @param {Boolean} bool
 * @return {SchemaType} this
 * @api public
 ...
 * #### Example:
 *
 *     const s = new Schema({ name: { type: String, sparse: true } ***REMOVED***
 *     s.path('name').index({ sparse: true ***REMOVED***
 *
 * @param {Boolean} bool
 * @return {SchemaType} this
 * @api public
 ...
 *
 *     await Model.create({ name: 'test' ***REMOVED***
 ...
 *     Model.updateOne({}, { $set: { name: 'test2' }, $inc: { age: 1 } ***REMOVED***
 *
 ...
 *     Model.updateOne({}, { name: 'test2' }, { strict: false ***REMOVED***
 *
 * @param {Boolean} bool
 * @return {SchemaType} this
 ...
 *     const Model = mongoose.model('Test', schema);
 *
 *     await Model.create({ date: new Date('2016-06-01') ***REMOVED***
 *     const doc = await Model.findOne();
 *
 ...
 *     const s = new Schema({ name: { type: String, set: capitalize }***REMOVED***
 *
 ...
 *
 *     const user = new User({email: 'AVENUE@Q.COM'***REMOVED***
 ...
 *     console.log(user.email); // 'avenue@q.com'
 *     User.updateOne({ _id: _id }, { $set: { email: 'AVENUE@Q.COM' } ***REMOVED*** // update to 'avenue@q.com'
 *
 ...
 *     const v = new Virus({ name: 'Parvoviridae', taxonomy: 'Parvovirinae' ***REMOVED***
 *
 ...
 * ***REMOVED***
 *     new Schema({ name: { type: String, validate: validator }***REMOVED***
 *
 *     // with a custom error message
 *
 *     const custom = [validator, 'Uh oh, {PATH} does not equal "something".']
 *     new Schema({ name: { type: String, validate: custom }***REMOVED***
 *
 ...
 *     ]
 *     new Schema({ name: { type: String, validate: many }***REMOVED***
 *
...
***REMOVED*** else if (message instanceof Object && !type) {
 ...
 * #### Example:
 *
 *     const userSchema = new Schema({ name: String ***REMOVED***
 *     ***REMOVED***
 *
 *     const postSchema = new Schema({ user: mongoose.ObjectId ***REMOVED***
