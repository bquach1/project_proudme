...
Query.prototype.mod = function() {
  ...
  if (1 === arguments.length) {
    ...
    val = arguments[0];
    path = this._path;
***REMOVED*** else if (2 === arguments.length && !Array.isArray(arguments[1])) {
    this._ensurePath('mod');
...
***REMOVED***
  ...
  const myFields = this._fields || (this._fields = {***REMOVED***
...
Query.prototype.hint = function() {
  ...
  const arg = arguments[0];
  if (utils.isObject(arg)) {
    const hint = this.options.hint || (this.options.hint = {***REMOVED***
