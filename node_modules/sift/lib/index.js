...
***REMOVED***; };
    var numericalOperation = function (createTester) {
        ...
        ***REMOVED***, owneryQuery, options, name);
        ***REMOVED***
***REMOVED***;
...
***REMOVED***;
    var $lt = numericalOperation(function (params) { return function (b) { return b < params; }; ***REMOVED***
    var $lte = numericalOperation(function (params) { return function (b) { return b <= params; }; ***REMOVED***
    var $gt = numericalOperation(function (params) { return function (b) { return b > params; }; ***REMOVED***
    var $gte = numericalOperation(function (params) { return function (b) { return b >= params; }; ***REMOVED***
