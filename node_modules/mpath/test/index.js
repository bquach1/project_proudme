    ...
    ***REMOVED***
    ...
    describe('with `special`', function() {
      ...
      ***REMOVED***
      ...
      describe('handles array.array.path', function() {
        it('with single', function(done) {
          ...
          o.arr.push({ _doc: { arr: 'something else' } ***REMOVED***
          o.arr.push({ _doc: { arr: ['something else'] } ***REMOVED***
          o.arr.push({ _doc: { arr: [[]] } ***REMOVED***
          o.arr.push({ _doc: { arr: [5] } ***REMOVED***
      ...
      ***REMOVED***
      ...
      describe('that is a function', function() {
        ...
        ***REMOVED***;
            ...
            assert.deepEqual(o, { hello: { world: [{ how: 'arrrr' }, { you: '?', how: 'arrrr' }] } ***REMOVED***
            done();
          ***REMOVED***
        ...
        ***REMOVED***;
            ...
            assert.deepEqual(o, { hello: { world: { how: 'RU' } } ***REMOVED***
            done();
          ***REMOVED***
        ***REMOVED***
      ...
      ***REMOVED***;
          ...
          assert.deepEqual(o, { hello: { world: [{ how: 'ºº' }, { you: '?', how: 'ºº' }] } ***REMOVED***
          done();
        ***REMOVED***
      ***REMOVED***
