...
export class AggregateOperation<T = Document> extends CommandOperation<T> {
  ...
  constructor(ns: MongoDBNamespace, pipeline: Document[], options?: AggregateOptions) {
    super(undefined, { ...options, dbName: ns.db ***REMOVED***
    ...
    if (typeof options?.out === 'string') {
      this.pipeline = this.pipeline.concat({ $out: options.out ***REMOVED***
      this.hasWriteStage = true;
***REMOVED*** else if (pipeline.length > 0) {
...
***REMOVED***
    ...
    if (this.hasWriteStage && this.writeConcern) {
      Object.assign(command, { writeConcern: this.writeConcern ***REMOVED***
***REMOVED***
