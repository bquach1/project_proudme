...
***REMOVED***
  ...
  if (topology.shouldCheckForSessionSupport()) {
    await topology.selectServerAsync(ReadPreference.primaryPreferred, {***REMOVED***
***REMOVED***
  ...
  if (topology.hasSessionSupport()) {
    if (session == null) {
      owner = Symbol();
      session = client.startSession({ owner, explicit: false ***REMOVED***
***REMOVED*** else if (session.hasEnded) {
      throw new MongoExpiredSessionError('Use of expired sessions is not permitted');
***REMOVED*** else if (session.snapshotEnabled && !topology.capabilities.supportsSnapshotReads) {
...
***REMOVED*** else if (session && !session.explicit) {
...
***REMOVED*** else if (operation.trySecondaryWrite) {
...
***REMOVED***
  ...
  const server = await topology.selectServerAsync(selector, { session ***REMOVED***
...
***REMOVED***
  ...
  if (
    ...
    session.unpin({ force: true, forceClear: true ***REMOVED***
***REMOVED***
