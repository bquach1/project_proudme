...
***REMOVED***
  ...
  ***REMOVED***
      ...
      return new WriteConcernError({ errmsg, code: MONGODB_ERROR_CODES.WriteConcernFailed ***REMOVED***
***REMOVED***
***REMOVED***
...
***REMOVED*** else if (isUpdateBatch(batch)) {
      executeOperation(
        bulkOperation.s.collection.s.db.s.client,
        new UpdateOperation(bulkOperation.s.namespace, batch.operations, finalOptions),
        resultHandler
      );
***REMOVED*** else if (isDeleteBatch(batch)) {
      executeOperation(
        bulkOperation.s.collection.s.db.s.client,
