...
***REMOVED***
  ...
  deleteMany(
    ...
    if (filter == null) {
      ...
      options = {};
      callback = undefined;
***REMOVED*** else if (typeof filter === 'function') {
...
***REMOVED*** else if (typeof filter === 'function') {
      (callback = filter as Callback<number>), (filter = {}), (options = {***REMOVED***
***REMOVED***
      if (arguments.length === 2) {
        if (typeof options === 'function') (callback = options), (options = {***REMOVED***
  ***REMOVED***
...
***REMOVED***
  ...
  distinct<Key extends keyof WithId<TSchema>>(
    ...
    if (typeof filter === 'function') {
      (callback = filter), (filter = {}), (options = {***REMOVED***
***REMOVED***
