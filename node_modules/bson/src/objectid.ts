...
***REMOVED*** else if (ArrayBuffer.isView(workingId) && workingId.byteLength === 12) {
      // If intstanceof matches we can escape calling ensure buffer in Node.js environments
      this[kId] = workingId instanceof Buffer ? workingId : ensureBuffer(workingId);
***REMOVED*** else if (typeof workingId === 'string') {
    ...
    ***REMOVED***
  ***REMOVED*** else if (workingId.length === 24 && checkForHexRegExp.test(workingId)) {
