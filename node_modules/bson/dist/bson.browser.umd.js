(function (global, factory) {
	...
	***REMOVED*** // Trim off extra bytes after placeholder bytes are found
	...
	***REMOVED*** // pad the end with zeros, but make sure to not forget the extra bytes
	...
	***REMOVED*** // Return an augmented `Uint8Array` instance
	...
	***REMOVED***; // Note: Change prototype *after* Buffer.from is defined to workaround Chrome bug:
	...
	***REMOVED***
	    ...
	    ***REMOVED***
	  ***REMOVED*** else if (!Buffer.isBuffer(buf)) {
	        throw new TypeError('"list" argument must be an Array of Buffers');
	  ***REMOVED***
	        buf.copy(buffer, pos);
	  ***REMOVED***
	...
	***REMOVED***
	  ...
	  function slowToString(encoding, start, end) {
	    ...
	    if (start === undefined || start < 0) {
	      start = 0;
	***REMOVED*** // Return early if start > this.length. Done here to prevent potential uint32
	    // coercion fail below.
	...
	***REMOVED***
	    ...
	    if (end <= 0) {
	      return '';
	***REMOVED*** // Force coercion to uint32. This will also coerce falsey/NaN values to 0.
	...
	***REMOVED***
	  ...
	  ***REMOVED***
	***REMOVED***
	***REMOVED*** // This property is used by `Buffer.isBuffer` (and the `is-buffer` npm package)
	...
	***REMOVED***
	    ...
	    if (y < x) return 1;
	    return 0;
	***REMOVED***; // Finds either the first index of `val` in `buffer` at offset >= `byteOffset`,
	...
	***REMOVED*** // Normalize byteOffset: negative offsets start from the end of the buffer
	...
	***REMOVED*** // Normalize val


	    if (typeof val === 'string') {
	      val = Buffer.from(val, encoding);
	***REMOVED*** // Finally, search either indexOf (if dir is true) or lastIndexOf
	...
	***REMOVED*** // Based on http://stackoverflow.com/a/22747272/680742, the browser with
	...
	***REMOVED*** // Decode in chunks to avoid "call stack size exceeded".
	...
	***REMOVED***; // copy(targetBuffer, targetStart=0, sourceStart=0, sourceEnd=buffer.length)
	...
	***REMOVED*** else if (typeof val === 'number') {
	      val = val & 255;
	***REMOVED*** else if (typeof val === 'boolean') {
	      val = Number(val);
	***REMOVED*** // Invalid ranges are not set to a default, so can range check early.
	...
	***REMOVED***
	    ...
	    return i;
	***REMOVED*** // ArrayBuffer or Uint8Array objects from other contexts (i.e. iframes) do not pass
	...
	***REMOVED*** // Create lookup table for `toString('hex')`
	...
	***REMOVED***;
	...
	Object.defineProperty(Binary.prototype, '_bsontype', { value: 'Binary' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(Code.prototype, '_bsontype', { value: 'Code' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(DBRef.prototype, '_bsontype', { value: 'DBRef' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(Long.prototype, '_bsontype', { value: 'Long' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(Decimal128.prototype, '_bsontype', { value: 'Decimal128' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(Double.prototype, '_bsontype', { value: 'Double' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(MaxKey.prototype, '_bsontype', { value: 'MaxKey' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(MinKey.prototype, '_bsontype', { value: 'MinKey' ***REMOVED***
	...
	***REMOVED***
	Object.defineProperty(ObjectId, 'get_inc', {
	    value: deprecate(function () { return ObjectId.getInc(); }, 'Please use the static `ObjectId.getInc()` instead')
	***REMOVED***
	Object.defineProperty(ObjectId.prototype, '_bsontype', { value: 'ObjectID' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(BSONRegExp.prototype, '_bsontype', { value: 'BSONRegExp' ***REMOVED***
	...
	***REMOVED***;
	...
	Object.defineProperty(BSONSymbol.prototype, '_bsontype', { value: 'Symbol' ***REMOVED***
	...
	***REMOVED***
	    ...
	    if (value.$undefined)
	        return null;
	    var keys = Object.keys(value).filter(function (k) { return k.startsWith('$') && value[k] != null; ***REMOVED***
	...
	***REMOVED***
	    if (isDBRefLike(value) || value.$dbPointer) {
	        ...
	        if (v instanceof DBRef)
	            return v;
	        var dollarKeys = Object.keys(v).filter(function (k) { return k.startsWith('$'); ***REMOVED***
	        var valid_1 = true;
	...
	***REMOVED***
	...
	function serializeArray(array, options) {
	    return array.map(function (v, index) {
	        options.seenObjects.push({ propertyName: "index ".concat(index), obj: null ***REMOVED***
	      ***REMOVED***
	...
	function serializeValue(value, options) {
	    if ((typeof value === 'object' || typeof value === 'function') && value !== null) {
	        var index = options.seenObjects.findIndex(function (entry) { return entry.obj === value; ***REMOVED***
	        if (index !== -1) {
	            var props = options.seenObjects.map(function (entry) { return entry.propertyName; ***REMOVED***
	...
	***REMOVED***,
	...
	function serializeDocument(doc, options) {
	    ...
	    if (typeof bsontype === 'undefined') {
	        ...
	        var _doc = {};
	        for (var name in doc) {
	            options.seenObjects.push({ propertyName: name, obj: null ***REMOVED***
	          ***REMOVED***
	...
	***REMOVED***
	    ...
	    ***REMOVED***
	        ...
	        ***REMOVED***
	                ...
	                if (!globalUTFValidation) {
	                    objectOptions = _assign(_assign({}, options), { validation: { utf8: shouldValidateKey } ***REMOVED***
	            ***REMOVED***
	    ...
	    ***REMOVED***
	        ...
	        ***REMOVED***
	            if (!globalUTFValidation) {
	                arrayOptions = _assign(_assign({}, arrayOptions), { validation: { utf8: shouldValidateKey } ***REMOVED***
	        ***REMOVED***
