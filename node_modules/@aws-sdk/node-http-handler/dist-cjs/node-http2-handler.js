    ...
    constructor(options) {
        ...
        this.configProvider = new Promise((resolve, reject) => {
            if (typeof options === "function") {
                options()
                    .then((opts) => {
                    resolve(opts || {***REMOVED***
            ***REMOVED***)
                    .catch(reject);
        ***REMOVED***
            else {
                resolve(options || {***REMOVED***
        ***REMOVED***
        ***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            ...
            ***REMOVED***
                ...
                rejectOriginal(err);
        ***REMOVED***;
            const queryString = (0, querystring_builder_1.buildQueryString)(query || {***REMOVED***
            ...
            ***REMOVED***
            ...
            req.on("response", (headers) => {
                ...
                ***REMOVED***
                fulfilled = true;
                resolve({ response: httpResponse ***REMOVED***
                if (disableConcurrentStreams) {
                    session.close();
